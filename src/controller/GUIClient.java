...
public class GUIClient {
        ...
        private static ConnectFourController connectFourController;

        public static void main(String[] args) {
            mainLauncher = new MainLauncher();
            mainLauncher.main(new String[1]);
        }

        public GUIClient() throws IOException {
            loginController = new LoginController();
            connectFourController = new ConnectFourController();
            lobbyController = new LobbyController();
            connectFourController.setClient(this);
            loginController.setClient(this);
            lobbyController.setClient(this);
            exts = new ArrayList<>();
        }

        public void connectMe(String ipAddr, String port) {
            try {
